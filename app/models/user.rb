class User < ActiveRecord::Base
  attr_accessible :email, :username, :firstname, :lastname, :city, :phone_number, :password, :password_confirmation, :new_password, :new_password_confirmation, :remember_me, :is_admin
